...
def lookup_needs_distinct(opts, lookup_path):
    ...
    https://github.com/django/django/blob/1.9.0/django/contrib/admin/utils.py#L22
    """
...
def quote(s):
    ...
    https://github.com/django/django/blob/1.9.0/django/contrib/admin/utils.py#L66-L73
    """
